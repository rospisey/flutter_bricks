...
import 'package:{{package_name}}/views/error_page.dart';
import 'package:{{package_name}}/views/home_page.dart';
import 'package:{{package_name}}/views/login_page.dart';
import 'package:{{package_name}}/views/onboarding_page.dart';
import 'package:{{package_name}}/views/splash_page.dart';
